...
class WxPayConfig extends WxPayConfigInterface
{
    //默认盛博数据参数
    //餐饮支付单独设置对应参数
    private $appId = 'wx92ca9596ed305fd7';
    private $merchantId = 'wx92ca9596ed305fd7';
    private $key = 'de98d9e78e69d558de4796e8d5e7d4de';
    private $appSecret = 'f6f520db96000fe51e6d9692152dd930';
    private $sslCertPath = '../cert/apiclient_cert.pem';
    private $sslKeyPath = '../cert/apiclient_key.pem';
