...
for($i = 0; $i < $n; $i++){
    ...
    $url = [
        //'http://v.douyin.com/MYHAY5/',
        'https://www.iesdouyin.com/share/video/6692569221320264964/?region=CN&mid=6681965210070305544&u_code=15d8lh5kc&titleType=title&utm_source=copy_link&utm_campaign=client_share&utm_medium=android&app=aweme&timestamp=1558249089',
        //'https://aweme.snssdk.com/aweme/v1/playwm/?video_id=v0200fd90000bjgfk67l54dcg0c6ejbg&line=0',
        //'http://v5-dy.ixigua.com/73e7caaad4da6d684684921340f7ad40/5ce10f48/video/m/2205695d0caf8644f94b7bb26801516745211621fe5000000d844689713c/?rc=am05M2Y3bzlpbTMzPGkzM0ApQHRoaGR1KTg5OzU2MzgzMzUzNDQzNDVvQGg2dilAZzN3KUBmM3UpcHpiczFoMXB6QCk1NGRfYmBkYTI0aGRfLS1hLS9zcy1vI2p0OmkzMy8uLzEvLi42NjI2MjYtOiNvIzphLW8jOmAtcCM6YGJiXmZeX3RiYl5gNS46'

        ];
    $re = doCurlGetRequest($url[array_rand($url)]);
    //$t = mt_rand(1,3);
   // sleep($t);
    ...
    //class=play-btn
//    $pos = strrpos ($re, '</script>');//echo $pos;
//    $str = '<script type="text/javascript">(function() {$(function() {setTimeout(function(){$(".play-btn").click();console.log($(".play-btn"));console.log("111");}, 1000);})})();</script>';
//    $res = mb_substr($re, 0, $pos) . $str . mb_substr($re, $pos);
//    $re = $res
